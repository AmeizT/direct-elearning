...
<body class="main">
	...
	<section>
				<div class="container-float" id="contact-page">
						<div id="div-overlay">
							...
							<div class="" id="hContent-pages">
									...
									<span>&nbsp;&nbsp;&nbsp;&nbsp; To Us<b>.</b></span>
									<p class="p-title">
										<a href="" class="glyphicon glyphicon-earphone" id="icons">&nbsp;Call-Us</a> 
										&nbsp;&nbsp;&nbsp;&nbsp;
										<a href="" class="glyphicon glyphicon-envelope" id="icons">&nbsp;E-mail</a>
									</p>
